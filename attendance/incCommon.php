	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'students' => array('Students', '', 'resources/table_icons/group.png', 'None'),
			'units' => array('Units', '', 'resources/table_icons/books.png', 'None'),
			'courses' => array('Courses', '', 'resources/table_icons/attributes_display.png', 'None'),
			'attendance' => array('Attendance Record', '', 'resources/table_icons/application_view_icons.png', 'None')
		);
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i><img src="chmsc.png" alt="..." width="5%"></i>CHMSC Attendance Management System</a>
			</div>
